...
2. The motivation letter is secondary and must be derived from selected CV/project evidence.
...
4. Write the motivation letter only from selected CV/project evidence.
