...
18. selected_project_ids must contain at least 3 relevant projects when available. Prefer overlap with job tasks, required skills and project evidence; avoid unrelated filler when a more relevant project exists.
